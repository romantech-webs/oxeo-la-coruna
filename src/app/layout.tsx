  ...
  return (
    <html lang="es">
      <head>
        ...
        <script dangerouslySetInnerHTML={{ __html: `window.__WIDGET_API_URL="https://automatizacion-webs.vercel.app";window.__PROJECT_ID="oxeo-la-coruna";` }} />

        <script
          src="https://automatizacion-webs.vercel.app/widget.js"
          data-project-name="Oxeo"
          data-api-url="https://automatizacion-webs.vercel.app"
          data-project-id="oxeo-la-coruna"
          data-primary-color="#9c6565"
          defer
        ></script>
      </head>
